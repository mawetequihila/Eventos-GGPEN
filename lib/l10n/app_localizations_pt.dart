...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get navSpeakers => 'Convidados';
  ...
  @override
  String get tabSpeakers => 'Intervenientes';

  @override
  String get roleModerators => 'Moderadores';

  @override
  String get roleSpeakers => 'Oradores';

  @override
  String get roleGuests => 'Convidados';
  ...
  @override
  String get speakersTitle => 'Convidados';
  ...
  @override
  String get formatPlenaria => 'Plenária';

  @override
  String get formatParalela => 'Paralela';
  ...
  @override
  String get authCreateAccount => 'Cadastro';

  @override
  String get authOr => 'ou';

  @override
  String get signupTitle => 'Cadastro';
  ...
  @override
  String get signupTermsLink => 'Termos de Uso';

  @override
  String get signupTermsAnd => ' e a ';
  ...
  @override
  String get passwordConfirmLabel => 'Confirmar palavra-passe';
  ...
  @override
  String get loginSubtitle => 'Bem-vindo de volta. Introduz os teus dados.';

  @override
  String get loginSubmit => 'Entrar';

  @override
  String get forgotPassword => 'Esqueci a palavra-passe';

  @override
  String get loginNoAccount => 'Ainda não tens conta?';

  @override
  String get loginCreateLink => 'Cadastrar';

  @override
  String get signupCheckEmail =>
      'Conta criada! Confirma o teu email e depois inicia sessão.';

  @override
  String get verifyEmailTitle => 'Confirma o teu email';

  @override
  String verifyEmailBody(String email) {
    return 'Enviámos um link de confirmação para $email. Abre a tua caixa de entrada e confirma a conta para poderes entrar.';
  }
  ...
  @override
  String get verifyEmailResent => 'Email de confirmação reenviado.';

  @override
  String get passwordResetSent =>
      'Enviámos um email para repores a palavra-passe.';

  @override
  String get authGenericError =>
      'Não foi possível concluir. Verifica os dados e tenta de novo.';

  @override
  String get termsDialogTitle => 'Termos de Uso';

  @override
  String get termsBody =>
      'Ao usares a aplicação GGPEN · Angotic 2026 aceitas estes Termos de Uso. A App é o guia oficial dos eventos do GGPEN.\n\nA tua conta: fornece dados verdadeiros e mantém o acesso seguro. És responsável pela atividade na tua conta.\n\nParticipação e dúvidas: és responsável pelo conteúdo que publicas. É proibido conteúdo ofensivo, ilegal, difamatório, enganoso ou spam. As dúvidas são moderadas e o GGPEN pode rejeitá-las ou removê-las. Ao submeteres, autorizas o GGPEN a exibir o teu conteúdo no contexto do evento.\n\nMarca e conteúdos: a marca GGPEN/Angotic, logótipos e materiais são propriedade do GGPEN e não podem ser usados sem autorização.\n\nServiço: disponibilizado tal como está e pode ser alterado ou interrompido. O GGPEN não se responsabiliza por indisponibilidades nem por conteúdos submetidos por utilizadores.\n\nDados: o tratamento dos teus dados rege-se pela Política de Privacidade.\n\nLei aplicável: legislação da República de Angola.\n\nAlterações: podemos atualizar estes Termos; o uso continuado implica aceitação.\n\nContacto: geral@ggpen.gov.ao';

  @override
  String get privacyDialogTitle => 'Política de Privacidade';

  @override
  String get privacyBody =>
      'O Gabinete de Gestão do Programa Espacial Nacional (GGPEN) é responsável pelo tratamento dos teus dados nesta aplicação.\n\nDados recolhidos: ao iniciar sessão com o Google, o teu nome, email e avatar; os dados que indicas (telefone, empresa, cargo); e as perguntas e gostos que submetes. Favoritos, lembretes e idioma ficam apenas no teu dispositivo. Não recolhemos localização.\n\nFinalidades: autenticar a sessão, mostrar a agenda e gerir a tua participação, enviar lembretes e informações do Angotic 2026, e comunicações do GGPEN e parceiros.\n\nPartilha: usamos o Supabase para alojar os dados, em nome do GGPEN, e o Google apenas no início de sessão. Não vendemos os teus dados.\n\nSegurança: ligações encriptadas e acesso por utilizador; as perguntas só ficam públicas após aprovação.\n\nOs teus direitos: podes aceder, corrigir e eliminar os teus dados, e pedir a eliminação da conta, através de geral@ggpen.gov.ao.\n\nGGPEN — Complexo Administrativo Clássicos de Talatona, Rua do MAT, Edifício n.º 3, 6.º andar, Belas — Luanda, Angola. Tel.: +244 222 777 312.';
  ...
  String get completeProfileReminderBody =>
      'Adiciona a empresa e o cargo no teu perfil.';
